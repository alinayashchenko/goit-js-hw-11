import{a as p,S as g,i as l}from"./assets/vendor-GIxeaSxt.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function t(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(e){if(e.ep)return;e.ep=!0;const r=t(e);fetch(e.href,r)}})();const y="https://pixabay.com/api/",h="52976301-a1fb84bd42c9f8b3493191a02";function b(n){const o={key:h,q:n,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:40};return p.get(y,{params:o}).then(t=>t.data)}const u=document.getElementById("gallery"),i=document.getElementById("loader"),L=new g(".gallery a",{captionsData:"alt",captionDelay:250});function A(n){if(!Array.isArray(n)||n.length===0)return;const o=n.map(t=>{const{webformatURL:a,largeImageURL:e,tags:r,likes:s,views:f,comments:d,downloads:m}=t;return`
